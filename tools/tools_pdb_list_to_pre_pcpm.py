...
================================ description ==================================
input a csv, the script will go to find the corresponding pdb file, in user's case, 
user should write  their own table.
=================================== input =====================================
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument( "--input_dp", default=r"pdb_list_to_pcpm.csv", help="big table")
    parser.add_argument( "--output_dp", default=r"pcpm.pkl", help="")
