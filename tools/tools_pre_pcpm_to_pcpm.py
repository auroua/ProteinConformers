...
================================ description ==================================
calculate the distribution from pre_pcpm
=================================== input =====================================
...
for CASP_ID in casp_ids:
    ...
    decoys_pcpm_dp = rf"/mnt/dna01/library2/proteinconformers/casp1415_pcpm/casp_14_15_labels_traintestval_{CASP_ID}.pkl" # generated using tools_pdb_list_to_pre_pcpm.py
    output_dp = rf"/mnt/rna01/zyh/prjs/proteinconformers/data/casp_14_15_labels_traintestval_pcpm_pt2/{CASP_ID}_pcpmap.pt"
